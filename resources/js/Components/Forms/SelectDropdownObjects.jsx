...
const SelectDropdownObjects = ({options, name, disabled = false, value, onChange, className = ''}) => {
    return (
        <select
            name={name}
            disabled={disabled}
            ...
            value={value}>
            <option className="font-bold" value="">{StringHelper.Capitalize(StringHelper.__("Choose a value"))}</option>
