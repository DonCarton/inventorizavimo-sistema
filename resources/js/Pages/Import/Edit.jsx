...
export default function Create({ auth, importableObjects, importDefinition }) {
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                        ...
                        <div className="mt-4">
                            ...
                            <select id="import_definition_model_class" name="import_definition_model_class" className="mt-1 block w-full border rounded-lg" value={data.model_class} onChange={e => setData('model_class', e.target.value)}>
                        ...
                        <div className="mt-4">
                            ...
                            <textarea id="import_definition_field_mappings" type="text" name="import_definition_field_mappings"
                                className="mt-1 block w-full border rounded-lg" value={data.field_mappings} onChange={e => setData('field_mappings', e.target.value)}/>
                            <FieldMappingForm
