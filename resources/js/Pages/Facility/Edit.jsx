        ...
        <div className="py-12">
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <EditForm disabled={processing} cancelButtonRoute="facilities.index" cancelButtonText={StringHelper.__("Cancel")} primaryButtonText={StringHelper.__("Save")} onSubmit={onSubmit} deleteButtonText={StringHelper.__("Delete")} deleteButtonOnClick={() => handleDestroy(facility.id)} canDelete={can.delete}>
                        <div className="mt-4">
