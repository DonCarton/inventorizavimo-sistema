...
export default function Index({ auth, inventoryItems, itemTypes, queryParams: initialQueryParams = null, success, failure }) {
    ...
    return (
        ...
        >
            ...
            <FileUploadModal
                modalHeaderText={StringHelper.__("Import Excel of data")}
                ...
                submitButtonText={StringHelper.__("Submit")}
                itemNotSpecifiedText={StringHelper.__("Nothing chosen yet")}
                selectFileText={StringHelper.__("Chosen file")}
                checkboxText={StringHelper.__("Receive results via mail")}
                isOpen={modalOpen}
                onClose={closeModal}
                onFileSelect={handleFileSelect}
                onFailsViaMailCheck={handleCheckbox}
                                                        ...
                                                        <BulkActionsButton>
                                                            {inventoryItem.can
                                                                ...
                                                                <MiscButton
                                                                    ...
                                                                    as="link"
                                                                    to={route("inventoryItems.editRaw",
                                                                        {
                                                                            inventoryItem:
                                                                                inventoryItem.id,
                                                                            query: queryParams,
