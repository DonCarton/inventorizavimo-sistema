...
export default function Edit({auth, inventoryItem}) {
    ...
    const onSubmit = (e) => {
        ...
        post(route('inventoryItems.create'));
    }
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit {inventoryItem.data.name}</h2>
                </div>
            }
        >
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            <div className="border-b border-gray-50 pb-6">
                                <div className="border-b border-black dark:border-gray-50 pb-6 mt-4">
